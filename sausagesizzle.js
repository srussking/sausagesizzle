 ...
 * sausagesizzle.js
 *
 * SausageSizzle user interface script
 * 
...
function (dojo, declare) {
    return declare("bgagame.sausagesizzle", ebg.core.gamegui, {
        constructor: function(){
            console.log('sausagesizzle constructor');
        ...
        */
        ...
        /*
            ...
            Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in
                  your sausagesizzle.game.php file.
